...
import { PipelineProgressFull } from "./PipelineProgress";
        ...
        <div className="flex-1 overflow-y-auto p-6">
          {activeTab === "overview" && (
            <div className="space-y-5">
              {/* Pipeline progress -- the hero of the Overview tab */}
              <PipelineProgressFull ticket={ticket} />
            ...
            <div className="space-y-6">
              ...
              {ticket.outputs.pdf_path && (
                <div>
                  ...
                  <a
                    href={`/outputs/${ticket.id}/${ticket.outputs.pdf_path}`}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-4 py-2.5 text-[13px] font-medium rounded-lg border transition-all hover:brightness-95"
                    style={{
